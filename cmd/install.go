...
func install(args []string) error {
	...
	for _, arg := range allArgs {
		...
		if arg != dashboard && componentVersions[arg] == "" {
			...
			argv = []string{"apply", "-f", "https://storage.googleapis.com/tekton-releases/" + arg + "/previous/" + componentVersions[arg] + "/release.yaml"}
			...
			argv = []string{"apply", "-f", "https://storage.googleapis.com/tekton-releases/" + arg + "/previous/" + componentVersions[arg] + "/tekton-dashboard-release.yaml"}
		}
